...
package com.xsy.generator.utils;

import com.xsy.generator.entity.ColumnEntity;
import com.xsy.generator.entity.TableEntity;
...
//        templates.add("template/postgresql.vm");
     ...
     * 获取文件名
     */
    public static String getFileName(String template, String className, String packageName, String projectName, String moduleName) {
        ...
        if (template.contains("Entity.java.vm")) {
            return packagePath + "pojo" + File.separator + "po" + File.separator + className + "Entity.java";
        }
        ...
        if (template.contains("Query.java.vm")) {
            return packagePath + "pojo" + File.separator + "dto" + File.separator + className + "Query.java";
        }
